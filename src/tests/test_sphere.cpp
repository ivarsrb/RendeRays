...
TEST_CASE("Ray-sphere interraction, ray O to z", "[sphere]") {
    CHECK(sphere_origin_small.Intersect(ray_origin_to_z, distance));
    CHECK(distance == Approx(0.5));
    CHECK(sphere_z_small.Intersect(ray_origin_to_z, distance));
    CHECK(distance == Approx(4.5));
    CHECK_FALSE(sphere_minus_z_small.Intersect(ray_origin_to_z, distance));
    CHECK_FALSE(sphere_x_small.Intersect(ray_origin_to_z, distance));
    CHECK_FALSE(sphere_y_small.Intersect(ray_origin_to_z, distance));
    CHECK(sphere_z_big.Intersect(ray_origin_to_z, distance));
    CHECK(distance == Approx(0.0));
    CHECK(sphere_minus_z_big.Intersect(ray_origin_to_z, distance));
    CHECK(distance == Approx(0.0));
    CHECK(sphere_x_big.Intersect(ray_origin_to_z, distance));
    CHECK(distance == Approx(0.0));
    CHECK(sphere_y_big.Intersect(ray_origin_to_z, distance));
    CHECK(distance == Approx(0.0));
}

TEST_CASE("Ray-sphere interraction, ray z to 0", "[sphere]") {
    CHECK(sphere_origin_small.Intersect(ray_z_to_origin, distance));
    CHECK(distance == Approx(9.5));
    CHECK(sphere_z_small.Intersect(ray_z_to_origin, distance));
    CHECK(distance == Approx(4.5));
    CHECK(sphere_minus_z_small.Intersect(ray_z_to_origin, distance));
    CHECK(distance == Approx(14.5));
    CHECK_FALSE(sphere_x_small.Intersect(ray_z_to_origin, distance));
    CHECK_FALSE(sphere_y_small.Intersect(ray_z_to_origin, distance));
    CHECK(sphere_z_big.Intersect(ray_z_to_origin, distance));
    CHECK(distance == Approx(0.0));
    CHECK(sphere_minus_z_big.Intersect(ray_z_to_origin, distance));
    CHECK(distance == Approx(10.0));
    CHECK(sphere_x_big.Intersect(ray_z_to_origin, distance));
    CHECK(distance == Approx(10.0));
    CHECK(sphere_y_big.Intersect(ray_z_to_origin, distance));
    CHECK(distance == Approx(10.0));
